...
struct List_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::infrastructure::Array3D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::infrastructure::Array3D_<ContainerAllocator> >::other >  _data_type;
  _data_type data;
